...
public abstract class StartActivity extends Activity implements
    ...
    private static final String TAG = "de.smart_sense.tracker.libs.StartActivity";

    public static final String BROADCAST_SENSOR_EVENT_NO = "de.smart_sense.tracker.libs.sensorEventNo";
    public static final String EXTRA_SENSOR_EVENT_NO = "de.smart_sense.tracker.libs.sensorEventNo.Extra";
    ...
    private class FolderSizeRetriever extends AsyncTask<String, Void, String> {
        ...
        private final static String TAG = "de.smart_sense.tracker.app.StartScreen.FolderSizeRetriever";
