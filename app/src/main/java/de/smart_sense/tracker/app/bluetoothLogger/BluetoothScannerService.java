...
public class BluetoothScannerService extends Service {
    ...
    public static final String ACTION_START_SERVICE = "de.smart_sense.tracker.app.bluetoothLogger.BluetoothScannerService.startLogging";
    public static final String ACTION_STOP_SERVICE = "de.smart_sense.tracker.app.bluetoothLogger.BluetoothScannerService.stopLogging";
